...
Route::get('/',function(){
    $fastfood = [
        ['type' => 'pizza','base' => 'price'],
        ['type' => 'burger','base' => 'test'],
        ['type' => 'pizza','base' => 'choice']
    ];
    return view('welcome',['fastfood' => $fastfood]);

});
//Route::redirect('/', '/pizzas');  //use for changing the route path
